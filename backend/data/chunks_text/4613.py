...
- Checks that the error message returned is "Could not validate credentials" and that the WWW-Authenticate header contains the expected value ('Bearer scope="me"')