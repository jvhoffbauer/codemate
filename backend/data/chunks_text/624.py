...
- The `test_tutorial` function takes an argument `clear_sqlmodel`, which is used to clear the SQLModel registry before each test case.
...
- Finally, the main application is run inside this patched environment, and the recorded calls are compared against the expected ones.