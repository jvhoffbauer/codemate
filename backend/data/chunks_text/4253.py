- Imports `app` and `client` from a specific module in the dependency testing tutorial for Python 3.10 (version 001)
...
- Extracts the JSON body of the response and asserts that it contains expected keys and values