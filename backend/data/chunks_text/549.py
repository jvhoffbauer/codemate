...
- Retrieves an Inspector object from the engine to check if tables have been created by SQLAlchemy during execution.
- Asserts that all expected tables exist after running the tutorial.